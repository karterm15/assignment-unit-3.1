...
let favoriteFoods = ['pizza', 'cheeseburger', 'cake'];
...
console.log('a desert i love', favoriteFoods);
...
console.log('adding entree to the beginning', favoriteFoods);
...
console.log('now we have only',colors);
...
let gemString = gems.join(' and '); //mini ah ha moment.  realized i needed to add space between 'and'!
