...
console.log('Refactor Last Animal:', lastanimal2);
...
console.log('added dessert:', favoriteFoods);
...
console.log('Last color popped?:', lastColor);
...
gems.sort();
gems.reverse();
console.log('reversed aphabetical order', gems);
...
console.log('Joined method:', gemString);
